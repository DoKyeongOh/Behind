...
<div id="comment-wrapper" >
    <textarea id="modefy-form" rows="5" class="text-center border border-dark border-3 rounded" >
        ${comment.content}
    </textarea>
</div>
<!-- 댓글 본문 -->
...
<ul id="reply-list" class="list-group list-group-flush">
    <c:forEach var="reply" items="${replies}">
        <li class="list-group-item display-inline-block">
            ...
            <form action="/report/page" method="get" class="display-inline-block" style="width: 1%">
