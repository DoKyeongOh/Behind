...
<div class="form-auth-input">
    <form class="input-form" method="post" action="${idCert}">
        ...
        <button type="submit" class="btn btn-primary btn-login-submit btn-auth-margin">
            인증번호 받기
        </button>
        <button type="submit" class="btn btn-outline-primary btn-login-submit btn-auth-margin">
            인증번호 다시받기
        </button>
    </form>
</div>
