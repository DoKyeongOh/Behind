...
<!-- 글 제목 -->
<br><br><br><br>
<h2 class="inline-block" id="post-title"> 글 제목 </h2>
<!-- 글 제목 -->
...
<div class="text-right inline-block" style="width: 92%;">
    ...
    <form action="/like" method="post" id="form-like">
        <input type="hidden" name="postNo" value="${posts[idx].postNo}">
...
<div id="post-wrapper" class="bg-dark">
    <div class="text-center">
      <img src="../../pictures/origin/1.jpeg" id="post-img">
      <div id="post-content">
...
<!-- 글 본문 -->
  ...
  <!-- 댓글 -->
  <h3 id="post-comments"> 댓글 </h3>
  <div class="comment-wrapper">
    <ul class="list-group">
      <li class="list-group-item">사람1 : 11111111 <button class="btn btn-outline-secondary btn-sm">자세히보기</button></li>
      <li class="list-group-item">사람1 : 11111111 <button class="btn btn-outline-secondary btn-sm">자세히보기</button></li>
      <li class="list-group-item">사람1 : 11111111 <button class="btn btn-outline-secondary btn-sm">자세히보기</button></li>
      <li class="list-group-item">사람1 : 11111111 <button class="btn btn-outline-secondary btn-sm">자세히보기</button></li>
    </ul>
